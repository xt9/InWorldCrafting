 ...
 */
public class ExplodeBlockRecipeCategory implements IRecipeCategory {
    private IDrawable background;

    public ExplodeBlockRecipeCategory(IGuiHelper guiHelper) {
        ResourceLocation base = new ResourceLocation(InWorldCrafting.MODID, "textures/gui/jei_explode.png");
    ...
    public String getUid() {
        return InWorldCrafting.MODID + ".exploding_blocks";
    }

 ...
 */
public class ExplodeItemRecipeCategory implements IRecipeCategory {
    private IDrawable background;

    public ExplodeItemRecipeCategory(IGuiHelper guiHelper) {
    ...
    public String getUid() {
        return InWorldCrafting.MODID + ".explode_item";
    }
